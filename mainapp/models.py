...
class ChatRoom(models.Model):
    ...
    password = models.CharField(
        verbose_name='Password', max_length=24, default='sfxf432')


class User(AbstractUser):
    # , through='UserChatRoomMembership'
    chatRooms = models.ManyToManyField(ChatRoom, related_name='users')
...
class Message(models.Model):
    ...
    date = models.DateTimeField(
        verbose_name='Date', default=datetime.datetime.now())
    owner = models.ForeignKey(User, default=1, verbose_name="Owner",
                              on_delete=models.CASCADE, related_name="messages")
    chatRoom = models.ForeignKey(ChatRoom, default=1, related_name='messages',
                                 on_delete=models.CASCADE, verbose_name="ChatRoom")
