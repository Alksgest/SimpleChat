...
urlpatterns = [
    ...
    path('api/chatRooms/<int:pk>',
         views.ChatRoomDetails.as_view(), name='chatroom-detail'),
    path('api/chatRooms/chat_room_redirect/',
         views.ChatRoomRedirect.as_view()),
    ...
    path('api/messages/<int:pk>',
         views.MessageDetails.as_view(), name='message-detail'),
]
